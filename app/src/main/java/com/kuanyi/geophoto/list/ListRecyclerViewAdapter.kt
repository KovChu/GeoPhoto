...
class ListRecyclerViewAdapter(val callback: onPhotoItemClicked) :
     ...
     */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PhotoInfoHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_photo_list_item, parent, false)
        return PhotoInfoHolder(view, callback)
    }
     ...
     */
    override fun onBindViewHolder(holder: PhotoInfoHolder, position: Int) {
